...
export default function Header() {
  ...
  return (
    <header className="absolute w-full flex justify-between items-center p-4 sm:p-5 lg:p-6 z-10">
      ...
      <div className="mr-0 lg:mr-64 flex items-center gap-2 sm:gap-3 relative">
        {/* Airports dropdown trigger */}
        <Link
          href="/locations"
          className="hover:scale-105 items-center text-white hover:text-[#bd843b] text-[12px] tracking-[1px] sm:tracking-[2px] transition-all duration-300"
          onMouseEnter={() => setShowAirports(true)}
          onMouseLeave={() => setShowAirports(false)}
        >
        ...
        <div className="relative">
          {showAirports && (
            <div className="absolute left-1/2 top-full -translate-x-1/2 mt-6 w-80 max-w-[90vw] rounded-sm bg-stone-900/80 text-white shadow-2xl border border-white/10 backdrop-blur-md overflow-hidden z-20">
              ...
              <ul role="menu" className="text-xs divide-y divide-white/10">
                <li
                  className="px-3 py-2 hover:bg-white/10 transition-colors flex items-center justify-between gap-2"
                  role="menuitem"
                >
        ...
        <Link
          href="/services"
          className="hover:scale-105 mr-2 sm:mr-4 items-center text-white hover:text-[#bd843b] text-[13px] tracking-[1px] sm:tracking-[2px] transition-all duration-300"
        >
        ...
        <Link href="/contact" aria-label="Go to Contact Page">
          <span className="border-gray-200 text-[#bd843b] leading-none border hover:border-[#8c5523] hover:cursor-pointer transition-colors duration-300 px-4 py-2 text-[12px] tracking-[1px] sm:tracking-[2px] bg-transparent">
            CONTACT
          </span>
        </Link>
      </div>
